// =============================================
// src/pages/members/MemberUpdate.jsx  (수정)
// - 단일 회원 조회로 초기값 채우고 PUT /v1/member/{id}
// =============================================
...
export default function MemberUpdate({ memNum, onCancel, onUpdated }) {
    ...
    const [form, setForm] = useState({ memName:'', memGender:'', memBirthday:'', memPhone:'', memEmail:'', memAddr:'', memNote:'' });
    ...
    const submit = async () => {
        ...
        setBusy(true);
        try {
        await axios.put(`http://localhost:9000/v1/member/${memNum}`, form);
